...
const maintController = __importStar(require("../controllers/maintenance.controller"));
const maintenance_validator_1 = require("../validators/maintenance.validator");
const auth_middleware_1 = require("../middleware/auth.middleware");
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authenticate);
router.post('/', maintenance_validator_1.validateMaintenance, maintController.create);
