...
router.post('/', vehicle_validator_1.validateVehicle, vehicleController.create);
router.get('/', vehicleController.findAll);
router.get('/:id', vehicleController.findById);
router.put('/:id', vehicle_validator_1.validateVehicle, vehicleController.update);
router.patch('/:id/status', vehicle_validator_1.validateVehicleStatus, vehicleController.updateStatus);
