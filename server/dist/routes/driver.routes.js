...
router.post('/', driver_validator_1.validateDriver, driverController.create);
router.get('/', driverController.findAll);
router.get('/:id', driverController.findById);
router.put('/:id', driver_validator_1.validateDriver, driverController.update);
router.patch('/:id/status', driver_validator_1.validateDriverStatus, driverController.updateStatus);
