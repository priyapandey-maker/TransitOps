...
const dashboardRepo = __importStar(require("../repositories/dashboard.repository"));
const getDashboardData = async () => {
    const [fleetSummary, driverSummary, tripSummary, maintenanceSummary, fuelSummary, expenseSummary, recentTrips] = await Promise.all([
