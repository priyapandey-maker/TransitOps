...
const create = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 201, 'Fuel log created successfully', result);
    }
    catch (error) {
        next(error);
    }
...
const findAll = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, 'Fuel logs retrieved successfully', result);
    }
    catch (error) {
        next(error);
    }
...
const findById = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, 200, 'Fuel log retrieved successfully', result);
    }
    catch (error) {
        next(error);
    }
